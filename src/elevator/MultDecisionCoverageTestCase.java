...
// JUnit 4.3
public class MultDecisionCoverageTestCase{
	
	public static junit.framework.Test suite(){
		return new junit.framework.JUnit4TestAdapter(MultDecisionCoverageTestCase.class);
	}
	...
	public void test6()
	{
		...
		oTestObject.handleEvent("stopElevatorAtFloorEvent");
		assertEquals(true, (oTestObject.state == State.Ligado_Parado));
		assertEquals(false, (oTestObject.hasMoreFloorToVisit.booleanValue() != false));
		oTestObject.handleEvent("noMoreFloorsEvent");
		assertEquals(true, (oTestObject.state == State.Ligado_Parado));
